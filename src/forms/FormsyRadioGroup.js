...
class FormsyRadioGroup extends FormsyComponent {
    static propTypes = {
...
const WithFormsyFormsyRadioGroup = withFormsy(FormsyRadioGroup);

export { WithFormsyFormsyRadioGroup as FormsyRadioGroup };
